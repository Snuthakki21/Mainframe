...
public final class JOB005 {
    // Run TOTALS from TOTALS.cbl; do not simplify its conditions.
    static void program_TOTALS(MfRuntime.Context ctx, Map<String,Object> dd, MfRuntime.Ref[] arguments) throws Exception {
        ...
        streams.put("OUTFILE", ctx.open(MfRuntime.obj(dd.get("TOTAL")), "OUTPUT", s.length("OUT-RECORD")));
